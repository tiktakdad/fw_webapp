...
class Reader(object):
    ...
    def __init__(self, lang_list, gpu=True, model_storage_directory=None,
        ...
        self.support_detection_network = ['craft', 'dbnet50']
        ...
        if recog_network in ['standard'] + [model for model in recognition_models['gen1']] + [model for model in recognition_models['gen2']]:
            ...
            if recognizer:
                if os.path.isfile(model_path) == False:
                    ...
                    print(model['url'], model['filename'])
    ...
    def readtext(self, image, decoder = 'greedy', beamWidth= 5, batch_size = 1,\
                 ...
                 threshold = 0.2, bbox_min_score = 0, bbox_min_size = 3, max_candidates = 0,
        ...
        #                                          threshold = 0, bbox_min_score = bbox_min_score,\
        #                                          bbox_min_size = bbox_min_size, max_candidates = max_candidates
        #                                          )
        # print(' horizontal_list, free_list: ',  horizontal_list, free_list)
        # get the 1st result from hor & free list as self.detect returns a list of depth 3
        horizontal_list, free_list = [[1, w - 1, 1, h - 1]], [] # horizontal_list[0], free_list[0]
